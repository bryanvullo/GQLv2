...
happyReduction_16 (HappyAbsSyn13  happy_var_2)
	(HappyTerminal (Tok _ (TokAlphaNum happy_var_1)))
	 =  HappyAbsSyn11
		 (Data (Id happy_var_1) happy_var_2
	)
...
happyReduction_17 ((HappyAbsSyn12  happy_var_4) `HappyStk`
	...
	happyRest)
	 = HappyAbsSyn11
		 (LabeledData (Id happy_var_1) happy_var_2 happy_var_4
	) `HappyStk` happyRest
...
happyReduction_18 ((HappyTerminal (Tok _ (TokString happy_var_6))) `HappyStk`
	...
	happyRest)
	 = HappyAbsSyn11
		 (RelationshipData (Id happy_var_1) happy_var_2 (Id happy_var_4) happy_var_6
	) `HappyStk` happyRest
